 ...
 *
 * $Header: reln.h,v 1.5 85/12/06 15:09:38 jas Exp $
 * $Log:	reln.h,v $
 * Revision 1.5  85/12/06  15:09:38  jas
 * Last_before_sfb
 * 
 * Revision 1.4  85/07/30  10:23:05  jas
 * Stable version ... releasable
 * 
 * Revision 1.3  85/06/13  10:30:53  jas
 * added clustering
 * 
 * Revision 1.2  85/06/08  16:48:20  jas
 * all buffered and cached
 * 
 * Revision 1.1  85/05/26  12:54:27  jas
 * Initial revision
 * 
 * 
 */
...
#define	MAXKEYS		32	/* max number of keys in relation */
...
*/
	...
	Int	rd_seg_buf_size;/* # bytes in segment buffers */
	Int	rd_seg_size;	/* # bytes in segment (buf + data) */
	Int	rd_total_segs;	/* total # of *physical* segments */
	...
	Int	rd_nlevsegs[MAXOVLEVELS]; /* # segments at each level */
/*
...
#define	Ts(rel)		((rel)->rd_total_segs)
...
#define	seg_buf_size(rel) ((rel)->rd_seg_buf_size)
 ...
 */
extern	Bool	rel_create(/* db_name, rname, static_info... */);
